defmodule Fedi.ActivityStreams.Property.LocationIterator do
  # This module was generated from an ontology. DO NOT EDIT!
  # Run `mix help ontology.gen` for details.

  @moduledoc """
  Iterator for the ActivityStreams "location" property.
  """
  ...
  def parent_module, do: Fedi.ActivityStreams.Property.Location
