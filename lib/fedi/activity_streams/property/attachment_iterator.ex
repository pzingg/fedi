defmodule Fedi.ActivityStreams.Property.AttachmentIterator do
  # This module was generated from an ontology. DO NOT EDIT!
  # Run `mix help ontology.gen` for details.

  @moduledoc """
  Iterator for the ActivityStreams "attachment" property.
  """
  ...
  def parent_module, do: Fedi.ActivityStreams.Property.Attachment
